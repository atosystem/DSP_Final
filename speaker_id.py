...
for epoch in range(N_epochs):
  ...
  for i in range(N_batches):
    print("Epoch #{} Batch #{}/{}".format(epoch,i,N_batches),end='')
    ...
    print(" loss_t={},err_t={}".format(loss_sum / i+1,err_sum / i+1),end='\r')
 

  loss_tot=loss_sum/N_batches
  err_tot=err_sum/N_batches
  print("Epoch#{} loss_tot={},err_tot={}".format(epoch,loss_tot,err_tot))
 
   
  # print("here",N_eval_epoch)
# Full Validation  new  
